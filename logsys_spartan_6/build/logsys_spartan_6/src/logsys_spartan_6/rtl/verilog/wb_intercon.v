...
wb_mux
  #(.num_slaves (2),
    .MATCH_ADDR ({32'h80000000, 32'h91000000}),
    .MATCH_MASK ({32'hf0000000, 32'hfffffffe}))
 wb_mux_or1k_d
   (.wb_clk_i  (wb_clk_i),
    .wb_rst_i  (wb_rst_i),
    ...
    .wbs_adr_o ({wb_ram_adr_o, wb_m2s_resize_gpio0_adr}),
    .wbs_dat_o ({wb_ram_dat_o, wb_m2s_resize_gpio0_dat}),
    .wbs_sel_o ({wb_ram_sel_o, wb_m2s_resize_gpio0_sel}),
    .wbs_we_o  ({wb_ram_we_o, wb_m2s_resize_gpio0_we}),
    .wbs_cyc_o ({wb_ram_cyc_o, wb_m2s_resize_gpio0_cyc}),
    .wbs_stb_o ({wb_ram_stb_o, wb_m2s_resize_gpio0_stb}),
    .wbs_cti_o ({wb_ram_cti_o, wb_m2s_resize_gpio0_cti}),
    .wbs_bte_o ({wb_ram_bte_o, wb_m2s_resize_gpio0_bte}),
    .wbs_dat_i ({wb_ram_dat_i, wb_s2m_resize_gpio0_dat}),
    .wbs_ack_i ({wb_ram_ack_i, wb_s2m_resize_gpio0_ack}),
    .wbs_err_i ({wb_ram_err_i, wb_s2m_resize_gpio0_err}),
    .wbs_rty_i ({wb_ram_rty_i, wb_s2m_resize_gpio0_rty}));
